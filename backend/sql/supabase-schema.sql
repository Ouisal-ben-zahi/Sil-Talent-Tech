-- ============================================
-- Schéma Supabase pour Sil Talents Tech
-- ============================================
-- 
-- Instructions:
...
-- 
-- Pour un backend API, on autorise toutes les opérations via la clé API
-- La sécurité est assurée par les guards NestJS et l'authentification JWT
-- ============================================
...
-- Autoriser toutes les opérations via la clé API (backend)
DO $$ BEGIN
...
-- ============================================
-- 
-- Note: Les tables ont maintenant RLS activé avec des politiques permissives
-- car la sécurité est gérée au niveau du site web NestJS.
-- ============================================
